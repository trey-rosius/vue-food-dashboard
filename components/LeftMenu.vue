<template>
  ...
  <a class="logo-expand" href="#">
   <ColorScheme placeholder="..." tag="span">food </ColorScheme>
   <ColorScheme placeholder="..." tag="span">dashboard </ColorScheme>
   
  </a>
     </div>
     <div class="side-menu">
        <a href="#" class="sidebar-link dashboard is-active">
  ...
  <a href="#" class="sidebar-link order">
 <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  Home </a>
  <a href="#" class="sidebar-link messages">
 <svg viewBox="0 0 512 512" fill="currentColor">
  ...
  Messages</a>
  <a href="#" class="sidebar-link settings">
  <svg viewBox="0 0 512 512" fill="currentColor">
...
z-index: 10;
 ...
 &-link{
   ...
   &:nth-child(2n + 1) {
     ...
     svg{
       background: var(--svg-background-color-1);
     }
   ...
   &:nth-child(2n) {
     ...
     svg{
       background: var(--svg-background-color-2);
     }
   ...
   &:nth-child(2n + 3) {
    ...
    svg{
       background: var(--svg-background-color-3);
    }
